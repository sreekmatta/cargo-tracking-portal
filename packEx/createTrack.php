...
<li>
    ...
    <div class="container">
     ...
     echo "<form action='./insertValuesIntoDatabase.php' method='post' name='myform'>
<table id='statusFeed' width=\"50%\" border=\"1\">\n";
  echo "<tr> \n";
    echo "<th bgcolor=\"#CCCCCC\" scope=\"col\">Tracking Number:  </th><td><input type='text' name='Tracking_id' class='form-control extra'  /> </td>
  </tr>";


  echo "<tr> \n";
    echo "<th bgcolor=\"#CCCCCC\" scope=\"col\">Status:  </th><td><input type='text' name='Status_id' class='form-control extra'/> </td>
  </tr>";

  echo "<tr> \n";
    echo "<th bgcolor=\"#CCCCCC\" scope=\"col\">Destination: </th><td><input type='text' name='destination_id' class='form-control extra' /></td>
  </tr>";
	

  echo "<tr> \n";
    echo "<th bgcolor=\"#CCCCCC\" scope=\"col\">Sender :  </th><td><input type='text' name='sendersname_id' class='form-control extra' /></td>
  </tr>";
	
  echo "<tr> ";
    echo "<th bgcolor=\"#CCCCCC\" scope=\"col\">Receiver :  </th><td><input type='text' name='receivers_id' class='form-control extra'/></td>
  </tr>
";
		
  echo "<tr> \n";
    echo "<th bgcolor=\"#CCCCCC\" scope=\"col\">Weight(Kg/Lbs) :  </div></th><td><input type='text' name='weight_id' class='form-control extra' /></td>
  </tr>
";
  echo "<tr> \n";
    echo "<th bgcolor=\"#CCCCCC\" scope=\"col\">Service Type:  </div></th><td><input type='text' name='service_id' class='form-control extra'/></td>
  </tr></table>";
	/*------------------------------------------------------Shipment Info------------------------------------------------------------*/	
 echo "<input type='button' name='commit' style='margin-top:40px;height:60px;' value='Insert New Tracking Details' onClick='myFunction()'>";
...
echo "<div id='rightBox' style='margin-top: -245px;height: 355px;'><div id='head' style='width: 511px;'>Update The Package Position and Time:</div> ";
  echo " <table id='shipment' style='border: 1px solid darkgray;width: 87%;margin-top: 35px;'><tr>";
   ...
   echo" <tr>
   <td><input type='text' id='calendar' "; echo "class='form-control extra1Date' name='Date' value='{$row['Date']}'/></td>
  ...
  <tr>
   <td><input type='text' id='calendar1' "; echo "class='form-control extra1Date' name='Date1' value='{$row['Date1']}'/></td>
  ...
  <tr>
    <td><input type='text' id='calendar2' "; echo "class='form-control extra1Date' name='Date2' value='{$row['Date2']}'/></td>
  ...
  <tr>
    <td><input type='text' id='calendar3' "; echo "class='form-control extra1Date' name='Date3' value='{$row['Date3']}'/></td>
  ...
  <tr>
    <td><input type='text' id='calendar4' class='form-control extra1Date' name='Date4' value='{$row['Date4']}'/></td>
  ...
  <tr>
    <td><input type='text' id='calendar5' "; echo "class='form-control extra1Date' name='Date5' value='{$row['Date5']}'/></td>
  ...
  echo "<tr>";
    echo" <td><input type='text' id='calendar6' "; echo "class='form-control extra1Date' name='Date6' value='{$row['Date6']}'/></td>";
...
?></p>
     <script type="text/javascript">
		function myFunction() 
		{
			document.myform.action = "./insertValuesIntoDatabase.php";
